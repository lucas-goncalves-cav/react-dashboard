/**
 * Inline SVG paths rather than an icon library.
 *
 * A dashboard uses perhaps fifteen icons. Pulling in a package for that adds
 * a dependency, a bundle cost and a tree shaking question, so the paths live
 * here instead.
 */
const PATHS: Record<string, string> = {
  ...
  products: 'm21 16-9 5-9-5V8l9-5 9 5v8ZM3.3 7.3 12 12l8.7-4.7M12 22V12',
  revenue: 'M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6',
  ticket: 'M3 9V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v2a2 2 0 0 0 0 6v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2a2 2 0 0 0 0-6Z',
  conversion: 'M22 12h-4l-3 9L9 3l-3 9H2',
